...
export const LiveCodePlayground: React.FC<Props> = ({ mode, token, onRunState }) => {
  ...
  return <>
    <section className="bg-white border border-slate-200 rounded shadow-xs overflow-hidden min-h-[680px] flex flex-col">
    ...
    <section className="bg-white border border-slate-200 rounded shadow-xs overflow-hidden flex flex-col min-h-[680px]">
